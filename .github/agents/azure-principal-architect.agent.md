...
tools: ['edit/editFiles', 'search', 'vscode/newWorkspace', 'execute/runInTerminal', 'execute/createAndRunTask', 'microsoftdocs/mcp/*', 'search/usages', 'vscode/vscodeAPI', 'read/problems', 'search/changes', 'execute/testFailure', 'vscode/openSimpleBrowser', 'web/fetch', 'web/githubRepo', 'vscode/extensions', 'execute/runTests']
---
